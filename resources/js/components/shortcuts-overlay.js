...
const GROUPS = [
  {
    ...
    rows: [
      ...
      { keys: ['⌃', '⌥', 'I'], desc: 'Picture-in-Picture — pin the focused window in a corner' },
  ...
  },
  {
    ...
    rows: [
      ...
      { keys: ['⏎'], desc: 'Dismiss the panel and return to the terminal' },
      { keys: ['Esc'], desc: 'Dismiss the panel' },
